...
const formatCurrency = (amount) => {
  ...
  return (
    <div className='flex'>
    <div className='w-[150rem] h-screen py-[3rem] px-[1.5rem]'>
    ...
    {read_products.filter((element) => element.type === 'Phones' || element.type === 'Tabs' || element.type === 'NOTEBOOK' || element.type === 'DESKTOP').map((filteredElement) => (
