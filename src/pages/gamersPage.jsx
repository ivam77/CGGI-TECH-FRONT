...
const formatCurrency = (amount) => {
  ...
  return (
    <div className='flex'>
      <div className='w-[100rem] h-screen py-[3rem] px-[1.5rem]'>
      ...
      <label htmlFor='product1'>Microphones</label>
    </div>
    <div className='flex items-center mt-1'>
      <input type='checkbox' id='product2' className='mr-2' />
      <label htmlFor='product2'>Pc's gamers</label>
    </div>
    <div className='flex items-center mt-1'>
      <input type='checkbox' id='product3' className='mr-2' />
      <label htmlFor='product3'>Chairs</label>
    </div>
    <div className='flex items-center mt-1'>
      <input type='checkbox' id='product4' className='mr-2' />
      <label htmlFor='product4'>Mouses</label>
    </div>
    </div>
    </div>
    <div className="flex flex-wrap justify-center py-[2rem] bg-[#e2e1e1]">
        
    {read_products.filter((element) => element.type === 'Mouse' || element.type === 'Chair' || element.type === 'pc' || element.type === "MICROPHONE").map((filteredElement) => (
  ...
  <img className="mb-4 h-[100px] lg:h-[10rem]" key={filteredElement._id} src={filteredElement.cover_photo[0]} alt="jg"  />
